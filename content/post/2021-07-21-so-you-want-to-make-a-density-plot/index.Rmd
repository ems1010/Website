---
title: So you want to make a density plot (of vowels)
author: Elena Sheard
date: '2021-07-21'
...
This is all the vowels in together. The basic framework of a vowel density plot is F2 along the horizontal axis and F1 along the vertical axis (as per a standard vowel chart). Don't forget to reverse the scale of the x and y axes as well. Then, `geom_density_2d()` adds in the contours of the plot. 
